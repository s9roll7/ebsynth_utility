...
def ebsynth_utility_process(stage_index: int, project_dir:str, original_movie_path:str, key_min_gap:int, key_max_gap:int, key_th:float, blend_rate:float, no_mask_mode:bool):
    args = locals()
    info = ""
    ...
    if stage_index == 0:
        ...
        ebsynth_utility_stage2(dbg, project_args, key_min_gap, key_max_gap, key_th)
    elif stage_index == 2:
        dbg.print("stage 3")
        dbg.print("")
        dbg.print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        ...
        dbg.print("4. Fill in the remaining configuration fields of img2img. No image and mask settings are required.")
        dbg.print("5. Generate")
